...
let loading=<AiOutlineLoading3Quarters className='w-7 h-7 text-white' />
  ...
  return (
<nav class="bg-main_blue border-gray-200 dark:bg-gray-900 sticky top-0">
  ...
  <div class="flex items-center md:order-2">
      ...
      <div class={`z-50 my-4 ${isOpen || "hidden"} absolute top-[40px] right-8 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700 dark:divide-gray-600" id="user-dropdown`}>
        <div class="px-4 py-3">
